...
describe('Mobile responsive behaviour', () => {
  ...
  describe('Bottom sheet renders CatalogueStrip at < 768px viewport', () => {
    ...
    it('hides the right panel on mobile (hidden md:flex)', async () => {
      ...
      const rightPanel = container.querySelector('.hidden.md\\:flex.w-56') || container.querySelector('.hidden.md\\:flex.w-72') || container.querySelector('.hidden.md\\:flex.w-64') || container.querySelector('.hidden.md\\:flex.w-80');
