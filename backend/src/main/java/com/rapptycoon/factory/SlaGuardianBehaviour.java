...
public class SlaGuardianBehaviour implements RappBehaviour {

    private static final BigDecimal BASE_HEALTH = new BigDecimal("5");
    private static final BigDecimal BASE_CUSTOMER_EXPERIENCE = new BigDecimal("10");
    private static final BigDecimal BASE_COST = new BigDecimal("15");
    ...
    private static final BigDecimal BASE_SLA_COMPLIANCE = new BigDecimal("20");
