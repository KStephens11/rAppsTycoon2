...
public class FaultPredictorBehaviour implements RappBehaviour {

    private static final BigDecimal BASE_HEALTH = new BigDecimal("15");
    ...
    private static final BigDecimal BASE_AUTOMATION_RELIABILITY = new BigDecimal("10");
    private static final BigDecimal BASE_SLA_COMPLIANCE = new BigDecimal("8");
